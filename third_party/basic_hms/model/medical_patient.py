...
#     medical_ethnicity_id = fields.Many2one('medical.ethnicity',string="Ethnic Group")
    marital_status = fields.Selection([('s','Soltero'),('m','Casado'),('w','Viudo'),('d','Divorciado'),('x','Separado')],string='Estado civil')
#     family_code_id = fields.Many2one('medical.family_code',string="Family")
    ...
    current_insurance_id = fields.Many2one('medical.insurance',string="Comp.Aseguradora")
